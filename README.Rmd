...
<li>`Code_Book.RMD`</li>
<ul>
<li>A description of the detailed process used to obtain the  new data frame `averages.text` and a descriptions of the variables contained in those two data sets</li>
</ul>
